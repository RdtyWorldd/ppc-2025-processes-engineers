...
int MorozovNBlockGaussFilterMPI::ProcessTiles(const std::vector<uint8_t> &tiles_data,
                                              const std::vector<int> &tiles_attr, int tiles_count,
...
void MorozovNBlockGaussFilterMPI::PrepareGatherData(int /* rank */, int mpi_size,
                                                    const std::vector<int> &proc_tile_count,
