...
Ускорение работы MPI версии программы отсутствует, потому что процесс вычисления количества, размеров и выделение пикслей тайлов из основного изображения отодвигает время начала фильтрации
## 8. Заключение
